...
void PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_owcpa_keypair(
  ...
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_sample_fg(f, g, seed);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_inv(invf_mod3, f);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_tobytes(sk, f);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_tobytes(
      sk + NTRU_PACK_TRINARY_BYTES, invf_mod3);

  /* Lift coeffs of f and g from Z_p to Z_q */
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Z3_to_Zq(f);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Z3_to_Zq(g);
  ...
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_mul(gf, g, f);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_inv(invgf, gf);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_mul(tmp, invgf, f);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Sq_mul(invh, tmp, f);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Sq_tobytes(
      sk + 2 * NTRU_PACK_TRINARY_BYTES, invh);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_mul(tmp, invgf, g);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_mul(h, tmp, g);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_sum_zero_tobytes(pk, h);
}

void PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_owcpa_enc(unsigned char *c,
                                                     const poly *r,
                                                     const poly *m,
  ...
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_sum_zero_frombytes(h, pk);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_mul(ct, r, h);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_lift(liftm, m);
  for (i = 0; i < NTRU_N; i++) {
    ct->coeffs[i] = ct->coeffs[i] + liftm->coeffs[i];
  }

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_sum_zero_tobytes(c, ct);
}

int PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_owcpa_dec(
  ...
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_sum_zero_frombytes(c,
                                                                   ciphertext);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_frombytes(f, secretkey);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Z3_to_Zq(f);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_mul(cf, c, f);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Rq_to_S3(mf, cf);

  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_frombytes(
      finv3, secretkey + NTRU_PACK_TRINARY_BYTES);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_mul(m, mf, finv3);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_tobytes(
  ...
  /* r = b / h mod (q, Phi_n) */
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Sq_frombytes(
      invh, secretkey + 2 * NTRU_PACK_TRINARY_BYTES);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_Sq_mul(r, b, invh);
  ...
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_trinary_Zq_to_Z3(r);
  PQCLEAN_NTRUHPS2048677SHUFFLING_CLEAN_poly_S3_tobytes(rm, r);

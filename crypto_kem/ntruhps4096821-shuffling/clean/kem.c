...
int PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_crypto_kem_keypair(uint8_t *pk,
  ...
  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_owcpa_keypair(pk, sk, seed);
...
int PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_crypto_kem_enc(uint8_t *c, uint8_t *k,
  ...
  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_rm(&r, &m, rm_seed);
  ...
  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_poly_Z3_to_Zq(&r);
  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_owcpa_enc(c, &r, &m, pk);
...
int PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_crypto_kem_dec(uint8_t *k,
  ...
  fail = PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_owcpa_dec(rm, c, sk);
  /* If fail = 0 then c = Enc(h, rm). There is no need to re-encapsulate. */
  /* See comment in PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_owcpa_dec for details.
   */
  ...
  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_cmov(k, rm, NTRU_SHAREDKEYBYTES,
                                             (unsigned char)fail);

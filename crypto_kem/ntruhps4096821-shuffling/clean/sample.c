...
void PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_fg(
    poly *f, poly *g, const unsigned char uniformbytes[NTRU_SAMPLE_FG_BYTES]) {

  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_iid(f, uniformbytes);
  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_fixed_type(
      g, uniformbytes + NTRU_SAMPLE_IID_BYTES);
}

void PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_rm(
    poly *r, poly *m, const unsigned char uniformbytes[NTRU_SAMPLE_RM_BYTES]) {

  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_iid(r, uniformbytes);
  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_fixed_type(
...
void PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_rejsamplingmod(
...
void PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_sample_fixed_type(
  poly *r, const unsigned char u[NTRU_SAMPLE_FT_BYTES]) {
  int16_t shuffle_indices[NTRU_N - 1];

  PQCLEAN_NTRUHPS4096821SHUFFLING_CLEAN_rejsamplingmod(shuffle_indices, (const uint16_t*)u);
